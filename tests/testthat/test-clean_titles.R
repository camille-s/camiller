context("test-clean_titles")
library(camiller)
library(testthat)

test_that("handles multiple space chars", {
...
test_that("converts all caps to title case", {
...
test_that("converts all caps to only capped first", {
...
test_that("retains running capitals", {
